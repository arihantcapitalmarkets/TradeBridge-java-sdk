...
public class ContractMasterResponse {
    ...
    @SerializedName("data")
    private ContractMasterData data = null;
    ...
    public ContractMasterData getData() {
        return data;
    }

    public void setData(ContractMasterData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        ContractMasterResponse that = (ContractMasterResponse) o;
