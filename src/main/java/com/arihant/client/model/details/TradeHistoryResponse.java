...
public class TradeHistoryResponse {
    ...
    @SerializedName("data")
    private TradeReportData data = null;
    ...
    public TradeReportData getData() {
        return data;
    }

    public void setData(TradeReportData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        TradeHistoryResponse that = (TradeHistoryResponse) o;
